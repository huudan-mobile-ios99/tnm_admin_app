...
class SocketManagerRL {
  static final SocketManagerRL _instance = SocketManagerRL._();
  factory SocketManagerRL() {
    return _instance;
  }
  IO.Socket? _socket;
  ...
  void initSocket() {
    ...
    _socket = IO.io(MyAPIStringRL.BASEURL_WEBSOCKET_RL, <String, dynamic>{
      // 'autoConnect': false,
